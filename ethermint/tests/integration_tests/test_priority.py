...
def test_native_tx_priority(ethermint):
    ...
    test_cases = [
        {
            ...
            "amount": "1000astake",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 600000}astake",
        ...
        },
        {
            ...
            "amount": "1000astake",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 400000}astake",
    ...
    for tc in test_cases:
        ...
        gas_price = int(tc["gas_prices"].removesuffix("astake"))
