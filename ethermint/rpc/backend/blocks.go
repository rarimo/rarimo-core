...
// block number
func (b *Backend) TendermintBlockByNumber(blockNum types.BlockNumber) (*tmrpctypes.ResultBlock, error) {
...
func (b *Backend) BlockNumberFromTendermint(blockNrOrHash types.BlockNumberOrHash) (types.BlockNumber, error) {
	switch {
...
func (b *Backend) EthMsgsFromTendermintBlock(
	...
	for i, tx := range block.Txs {
		...
		if !types.TxSuccessOrExceedsBlockGasLimit(txResults[i]) {
