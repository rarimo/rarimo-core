...
import (
	...
	"gitlab.com/rarimo/rarimo-core/ethmintindexer"
	"gitlab.com/rarimo/rarimo-core/ethmintrpc/backend/mocks"
...
func (suite *BackendTestSuite) SetupTest() {
	...
	idxer := ethmintindexer.NewKVIndexer(dbm.NewMemDB(), ctx.Logger, clientCtx)
