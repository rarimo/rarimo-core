...
var fileDescriptor_6f732db15fd3859c = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LastUpdateOperationIndex) > 0 {
		...
		i = encodeVarintCscalist(dAtA, i, uint64(len(m.LastUpdateOperationIndex)))
		i--
		dAtA[i] = 0x22
	}
	if m.UpdatedAtBlock != 0 {
		i = encodeVarintCscalist(dAtA, i, uint64(m.UpdatedAtBlock))
		i--
		dAtA[i] = 0x18
	}
	if m.RootUpdated {
...
func (m *Params) Size() (n int) {
	...
	if m.UpdatedAtBlock != 0 {
		n += 1 + sovCscalist(uint64(m.UpdatedAtBlock))
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdatedAtBlock", wireType)
			}
			m.UpdatedAtBlock = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UpdatedAtBlock |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
