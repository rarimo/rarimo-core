...
var (
	filter_Query_VotesByProposal_0 = &utilities.DoubleArray{Encoding: map[string]int{"proposalId": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"rarimo", "rarimo-core", "multisig", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_GroupAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"rarimo", "rarimo-core", "multisig", "group"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Group_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"rarimo", "rarimo-core", "multisig", "group", "account"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Proposal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"rarimo", "rarimo-core", "multisig", "proposal", "proposalId"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ProposalAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"rarimo", "rarimo-core", "multisig", "proposal"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Vote_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"rarimo", "rarimo-core", "multisig", "vote", "proposalId", "voter"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_VoteAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"rarimo", "rarimo-core", "multisig", "vote"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_VotesByProposal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"rarimo", "rarimo-core", "multisig", "vote", "proposalId"}, "", runtime.AssumeColonVerbOpt(true)))
)
