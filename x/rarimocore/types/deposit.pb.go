...
type Deposit struct {
	...
	Signed     bool   `protobuf:"varint,11,opt,name=signed,proto3" json:"signed,omitempty"`
...
func (m *Deposit) GetBundleData() string {
	if m != nil {
		return m.BundleData
	}
	return ""
...
func (m *Deposit) GetBundleSalt() string {
	if m != nil {
		return m.BundleSalt
	}
	return ""
...
var fileDescriptor_24f8a86eafda8811 = []byte{
	...
	,
}
...
func (m *Deposit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BundleSalt) > 0 {
		...
		i = encodeVarintDeposit(dAtA, i, uint64(len(m.BundleSalt)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.BundleData) > 0 {
		...
		i = encodeVarintDeposit(dAtA, i, uint64(len(m.BundleData)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Amount) > 0 {
